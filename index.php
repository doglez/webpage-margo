    ...
    <main>
      ...
      <section class="section_achievements grey lighten-3">
        <div class="row container">
          <div class="col m4 s12 section_achievements_hover">
      ...
      <section class="section_comments white-text">
        <div class="row container">
          <div class="card col m6 s12 laptop_upload_sar"></div>
          <div class="card col m6 s12 section_comments_text blue-grey darken-1">
        ...
        <div class="row container">
          <div class="card col s12 hide-on-med-and-up money_plants"></div>
          <div class="card col m6 s12 section_comments_text blue-grey darken-1">
          ...
          <div class="card col m6 hide-on-small-only money_plants"></div>
        </div>
      </section>
    </main>
